...
from .UnscentedPredict import UnscentedPredict
from .UnscentedCorrect import UnscentedCorrect

import numpy as np

class UnscentedKalman(KalmanFilter):
    ...
    def __init__(self, f_func, h_func, f_args, h_args, alpha=10**(-3), beta=2, kappa=0, d=2, sigma_a=0.1, image_size = (4094, 2046)):
        ...
        self.ipredict = UnscentedPredict(f_func, f_args, Wm, Wc, lambda_, d, sigma_a, image_size)
        self.icorrect = UnscentedCorrect(f_func, h_func, f_args, h_args, Wm, Wc, lambda_, d, image_size)
